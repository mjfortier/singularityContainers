...
%post
  apt update
  apt install vim make curl build-essential git libnetcdff-dev git zip unzip python3 m4 gfortran netcdf-bin nano zlib1g mpich doxygen gedit python3 python3-pip nco ncview libopenmpi-dev r-base libgeos-dev libgdal-dev libproj-dev pandoc poppler-utils texlive-latex-base -y -f -m
